...
import { SettingPaths } from "features/teacher_setting/teacher_setting";
import { AuthPathsEnum } from "features/teacher_auth/teacher_auth";
import { getMyAvatar } from "features/teacher_users/teacher_users";
import { logout } from "features/teacher_auth/redux/auth.slice";
...
const HeaderLayout = ({
  ...
  return (
    <Header className={cx(styles.header, "flex-space-between-center gap-20")}>
      ...
      <Title level={4} className="mb-25">Teacher</Title>
      <DropdownButton
        menuProps={{
          items: [
            {
