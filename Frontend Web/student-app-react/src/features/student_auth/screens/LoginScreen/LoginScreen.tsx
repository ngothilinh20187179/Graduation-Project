...
import { login } from "features/student_auth/redux/auth.slice";
import { RoleType } from "features/student_auth/constants/auth.constants";
...
const LoginScreen = () => {
  ...
  return (
    <div className={cx(styles.loginScreen)}>
      ...
      <Typography className={cx(styles.title)}>Student Login</Typography>
      <Form
        form={form}
        labelCol={{ span: 8 }}
        wrapperCol={{ span: 16 }}
